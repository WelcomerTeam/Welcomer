...
const (
	...
	AuditTypeGiveaways
	// AuditTypePolls is a AuditType of type Polls.
	AuditTypePolls
)

var ErrInvalidAuditType = errors.New("not a valid AuditType")

const _AuditTypeName = "unknownborderwall_requestscustom_botsguild_settings_autorolesguild_settings_borderwallguild_settings_freerolesguild_settings_leaverguild_settings_rulesguild_settings_tempchannelsguild_settings_timerolesguild_settings_welcomerguild_settings_welcomer_dmsguild_settings_welcomer_imagesguild_settings_welcomer_textguildsuserswelcomer_imagesguild_featuresbiobot_customisationguild_settings_reactionrolesgiveawayspolls"
...
var _AuditTypeMap = map[AuditType]string{
	...
	AuditTypePolls:                       _AuditTypeName[407:412],
}
...
var _AuditTypeValue = map[string]AuditType{
	...
	_AuditTypeName[407:412]: AuditTypePolls,
}
