...
CREATE INDEX IF NOT EXISTS idx_science_guild_events_guild_id_event_type_user_id_created_at ON science_guild_events (guild_id, event_type, user_id, created_at);
