...
type Querier interface {
	...
	GetCustomBotByApplicationId(ctx context.Context, applicationID int64) (*CustomBots, error)
	GetCustomBotByGuildId(ctx context.Context, guildID int64) (*CustomBots, error)
	...
	UpdateCustomBotApplication(ctx context.Context, arg UpdateCustomBotApplicationParams) (*CustomBots, error)
