	...
	requireOAuthAuthorization(ctx, func(ctx *gin.Context) {
		requireMutualGuild(ctx, func(ctx *gin.Context) {
			requireGuildElevation(ctx, func(ctx *gin.Context) {
				...
				// TODO: Get custom welcomer backgrounds

				partial := GuildSettingsWelcomerSettingsToPartial(welcomerText, welcomerImages, welcomerDMs, customIDs)
...
// POST /api/guild/:guildID/welcomer/background
func setGuildWelcomerBackground(ctx *gin.Context) {
	requireOAuthAuthorization(ctx, func(ctx *gin.Context) {
		requireMutualGuild(ctx, func(ctx *gin.Context) {
			requireGuildElevation(ctx, func(ctx *gin.Context) {
			})
...
func registerGuildSettingsWelcomerRoutes(g *gin.Engine) {
	...
	g.POST("/api/guild/:guildID/welcomer/background", setGuildWelcomerBackground)
}
