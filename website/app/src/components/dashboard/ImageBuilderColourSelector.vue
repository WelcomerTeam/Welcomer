    ...
    <div v-else>
      <div :class="[
        ...
        <div class="border-b border-gray-300 dark:border-secondary-light">
          <nav class="flex display-flex justify-evenly flex-col" aria-label="Tabs">
            <a v-for="tab in tabs" :key="tab.name" @click="this.page = tab.enabled ? tab.value : this.page" :class="[
              ...
              'whitespace-nowrap flex py-2 px-1 border-b-2 font-medium text-sm cursor-pointer w-full justify-center',
