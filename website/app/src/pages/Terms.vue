    ...
    <main>
      ...
      <div class="bg-white text-gray-900 hero-preview prose-lg text-justify rounded-lg">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Welcomer, accessible
              from
              <a href="https://welcomer.gg/">https://welcomer.gg</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          You represent that you are over the age of 13. We do not
        ...
        <h2 id="for-european-union-eu-users">
        ...
        <h2 id="translation-interpretation">
        ...
        <ul>
          <li>
            By email:
            <a href="mailto:hello@welcomer.gg">hello@welcomer.gg</a>
          </li>
        </ul>
      </div>
    </main>
