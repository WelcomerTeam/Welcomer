  ...
  <div class="relative min-h-screen">
    ...
    <main>
      ...
      <div class="bg-white text-gray-900 hero-preview prose-lg text-justify rounded-lg">
        ...
        <p><strong>Last updated May 14, 2022</strong></p>
        <p>
          This privacy notice for Welcomer (’
          <strong>Welcomer</strong> ', ‘<strong>we</strong>’,
        ...
        <ul>
          <li>
            <p>
              ...
              <a href="http://welcomer.gg">welcomer.gg</a> , or any
        ...
        <p>
          ...
          <a href="mailto:rock@welcomer.gg">rock@welcomer.gg</a>.
        </p>
        ...
        <p>
          ...
          Welcomer and the Services, the choices you make, and the
        ...
        <p>
          <strong>How do I exercise my rights?</strong> The easiest way
          to exercise your rights is by contacting us. We will consider
          and act upon any request in accordance with applicable data
          protection laws.
        </p>
        <p>
          Want to learn more about what Welcomer does with any
          information we collect? Click
          <a href="#toc">here</a> to
        ...
        <p>
          <a href="#legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR
            PERSONAL
            INFORMATION?</a>
        </p>
        <p>
          <a href="#whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL
            INFORMATION?</a>
        </p>
        <p>
        ...
        <p>
          <a href="#caresidents">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY
            RIGHTS?</a>
        </p>
        <p>
        ...
        <p>
          <a href="#request">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE
            COLLECT FROM YOU?</a>
        </p>
        <p><strong id="infocollect">1. WHAT INFORMATION DO WE COLLECT?</strong></p>
        ...
        <p>
          ...
          media account details, like your Discord or other social media
        ...
        <p>
          <strong><em>In Short:</em></strong>
          <em>Some information — such as your Internet Protocol (IP)
        ...
        <p><strong id="infouse">2. HOW DO WE PROCESS YOUR INFORMATION?</strong></p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>We process your information to provide, improve, and
        ...
        <p>
          <strong>We process your personal information for a variety of
            reasons, depending on how you interact with our Services,
            including:</strong>
        </p>
        <ul>
          <li>
            <strong>To save or protect an individual’s vital
              interest.</strong>
        ...
        <p>
          <strong id="legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR
            INFORMATION?</strong>
        </p>
        <p>
          <em><strong>In Short:</strong> We only process your personal
            ...
            to provide you with services to enter into or fulfil our
            contractual obligations, to protect your rights, or to
            fulfil our legitimate business interests.</em>
        </p>
        <p>
        ...
        <p>
          <strong i="whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL
            INFORMATION?</strong>
        </p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>We may share information in specific situations described
        ...
        <p>
          <strong id="cookies">5. DO WE USE COOKIES AND OTHER TRACKING
            TECHNOLOGIES?</strong>
        </p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>We may use cookies and other tracking technologies to
        ...
        <p><strong id="sociallogins">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</strong></p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>If you choose to register or log in to our services using a
        ...
        <p>
          ...
          Discord logins). Where you choose to do this, we will receive
        ...
        <p><strong id="inforetain">7. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>We keep your information for as long as necessary to fulfil
        ...
        <p><strong id="infosafe">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong></p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>We aim to protect your personal information through a
        ...
        <p><strong id="privacyrights">9. WHAT ARE YOUR PRIVACY RIGHTS?</strong></p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>In some regions, such as the European Economic Area (EEA),
        ...
        <p>
          ...
          of our Services. To opt out of interest-based advertising by
          advertisers on our Services visit
          <a href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</a>.
        </p>
        <p><strong id="DNT">10. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></p>
        <p>
          ...
          for recognising and implementing DNT signals has been
        ...
        <p>
          <strong id="caresidents">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY
            RIGHTS?</strong>
        </p>
        <p>
          <strong><em>In Short:</em></strong>
          <em>Yes, if you are a resident of California, you are granted
        ...
        <p>
          <strong>What categories of personal information do we
            collect?</strong>
        </p>
        <p>
        ...
        <p>
          ...
          practices can be found in this privacy notice. You may contact
          us by email at
          <a href="mailto:data@welcomer.gg">data@welcomer.gg</a> , or by
          referring to the contact details at the bottom of this
          document. If you are using an authorised agent to exercise
          your right to opt out we may deny a request if the authorised
        ...
        <p>
          Welcomer has not disclosed or sold any personal information to
          third parties for a business or commercial purpose in the
          preceding twelve (12) months. Welcomer will not sell personal
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              an authorised agent that does not submit proof that they
              have been validly authorised to act on your behalf in
        ...
        <p><strong id="policyupdates">12. DO WE MAKE UPDATES TO THIS NOTICE?</strong></p>
        <p>
          <em><strong>In Short:</strong> Yes, we will update this notice
            as necessary to stay compliant with relevant laws.</em>
        </p>
        <p>
        ...
        <p>
          <strong id="contact">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong>
        </p>
        <p>
          If you have questions or comments about this notice, you may
          email us at
          <a href="mailto:data@welcomer.gg">data@welcomer.gg</a>
        </p>
        <p>
          <strong id="request">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE
            COLLECT FROM YOU?</strong>
        </p>
        <p>
          Based on the applicable laws of your country, you may have the
          right to re quest access to the personal information we collect
