...
require (
	...
	github.com/WelcomerTeam/Sandwich v0.0.0-20250526181512-3510f834ce1c // indirect
	github.com/WelcomerTeam/Sandwich-Daemon v0.0.0-20250531083823-9b5f5ab350e1 // indirect
