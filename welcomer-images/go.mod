...
require (
	...
	github.com/WelcomerTeam/Sandwich v0.0.0-20250315102642-ec7fce2619f8 // indirect
	github.com/WelcomerTeam/Sandwich-Daemon v0.0.0-20250315093219-f03512f69893 // indirect
